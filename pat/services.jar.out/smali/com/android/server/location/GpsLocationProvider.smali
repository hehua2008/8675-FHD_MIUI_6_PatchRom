...
.field private static final AGPS_CONTENT_URI:Landroid/net/Uri;
...
.method public constructor <init>(Landroid/content/Context;Landroid/location/ILocationManager;Landroid/os/Looper;)V
    ...
    iput-object v2, v0, Lcom/android/server/location/GpsLocationProvider;->mLock:Ljava/lang/Object;
    ...
    iput v2, v0, Lcom/android/server/location/GpsLocationProvider;->mInjectNtpTimePending:I
    ...
    iput v2, v0, Lcom/android/server/location/GpsLocationProvider;->mDownloadXtraDataPending:I
    ...
    iput-object v2, v0, Lcom/android/server/location/GpsLocationProvider;->mClientSource:Landroid/os/WorkSource;
    ...
    .line 1052
    new-instance v2, Lcom/android/server/location/GpsLocationProvider$6;

    move-object/from16 v0, p0

    invoke-direct {v2, v0}, Lcom/android/server/location/GpsLocationProvider$6;-><init>(Lcom/android/server/location/GpsLocationProvider;)V

    move-object/from16 v0, p0

    iput-object v2, v0, Lcom/android/server/location/GpsLocationProvider;->mGpsGeofenceBinder:Landroid/location/IGpsGeofenceHardware;

    .line 1787
    new-instance v2, Lcom/android/server/location/GpsLocationProvider$7;

    move-object/from16 v0, p0

    invoke-direct {v2, v0}, Lcom/android/server/location/GpsLocationProvider$7;-><init>(Lcom/android/server/location/GpsLocationProvider;)V
    ...
    .line 2004
    new-instance v2, Lcom/android/server/location/GpsLocationProvider$8;

    move-object/from16 v0, p0

    iget-object v3, v0, Lcom/android/server/location/GpsLocationProvider;->mHandler:Landroid/os/Handler;

    move-object/from16 v0, p0

    invoke-direct {v2, v0, v3}, Lcom/android/server/location/GpsLocationProvider$8;-><init>(Lcom/android/server/location/GpsLocationProvider;Landroid/os/Handler;)V

    move-object/from16 v0, p0

    iput-object v2, v0, Lcom/android/server/location/GpsLocationProvider;->mDefaultApnObserver:Landroid/database/ContentObserver;
    ...
    iput-object v0, v1, Lcom/android/server/location/GpsLocationProvider;->mILocationManager:Landroid/location/ILocationManager;
    ...
    iput-object v2, v0, Lcom/android/server/location/GpsLocationProvider;->mAppOpsService:Lcom/android/internal/app/IAppOpsService;
    ...
    invoke-direct {v2, v0, v1}, Lcom/android/server/location/GpsLocationProvider$ProviderHandler;-><init>(Lcom/android/server/location/GpsLocationProvider;Landroid/os/Looper;)V

    move-object/from16 v0, p0

    iput-object v2, v0, Lcom/android/server/location/GpsLocationProvider;->mHandler:Landroid/os/Handler;

    .line 569
    invoke-direct/range {p0 .. p0}, Lcom/android/server/location/GpsLocationProvider;->listenForBroadcasts()V
    ...
    invoke-direct {v3, v0}, Lcom/android/server/location/GpsLocationProvider$3;-><init>(Lcom/android/server/location/GpsLocationProvider;)V
...
.method static synthetic access$3100(Lcom/android/server/location/GpsLocationProvider;)Ljava/lang/String;
    .locals 1
    .param p0, "x0"    # Lcom/android/server/location/GpsLocationProvider;
...
.method static synthetic access$3102(Lcom/android/server/location/GpsLocationProvider;Ljava/lang/String;)Ljava/lang/String;
    .locals 0
    .param p0, "x0"    # Lcom/android/server/location/GpsLocationProvider;
...
.method private handleSetRequest(Lcom/android/internal/location/ProviderRequest;Landroid/os/WorkSource;)V
    ...
    .line 943
    invoke-direct {p0, v5}, Lcom/android/server/location/GpsLocationProvider;->startNavigating(Z)V
...
.method private reportLocation(IDDDFFFJ)V
    ...
    iget-object v2, v0, Lcom/android/server/location/GpsLocationProvider;->mILocationManager:Landroid/location/ILocationManager;
    ...
    iget v2, v0, Lcom/android/server/location/GpsLocationProvider;->mTimeToFirstFix:I
    ...
    iget v4, v0, Lcom/android/server/location/GpsLocationProvider;->mTimeToFirstFix:I
    ...
    .restart local v17    # "valueColumn":I
    :cond_4
    :try_start_7
    invoke-interface {v8}, Landroid/database/Cursor;->moveToNext()Z
    :try_end_7
    ...
    iget-object v2, v0, Lcom/android/server/location/GpsLocationProvider;->mClientSource:Landroid/os/WorkSource;

    iget-boolean v3, v0, Lcom/android/server/location/GpsLocationProvider;->mNavigating:Z

    invoke-static {v2, v3, v11}, Lcom/android/server/location/GpsLocationProviderInjector;->appendUidExtra(Landroid/os/WorkSource;ZLandroid/content/Intent;)V
    ...
    invoke-virtual {v2, v11, v3}, Landroid/content/Context;->sendBroadcastAsUser(Landroid/content/Intent;Landroid/os/UserHandle;)V
...
.method private startNavigating(Z)V
    ...
    .line 1132
    .local v13, "tmpSuplServerHost":Ljava/lang/String;
    const/4 v14, -0x1

    .line 1133
    .local v14, "tmpSuplServerPort":I
    const/4 v15, -0x1

    .line 1134
    .local v15, "tmppositionMode":I
    const/4 v8, 0x0
    ...
    const-string v4, "tmpSuplServerHost: "
    ...
    const-string v4, ", tmpSuplServerPort: "
    ...
    iput-object v13, v0, Lcom/android/server/location/GpsLocationProvider;->mSuplServerHost:Ljava/lang/String;
    ...
    const-string v4, ", mEngineCapabilities: "
    ...
    iget v4, v0, Lcom/android/server/location/GpsLocationProvider;->mEngineCapabilities:I
    ...
    const-string v3, "mPositionMode: GPS_POSITION_MODE_STANDALONE"
    ...
    .end local v13    # "tmpSuplServerHost":Ljava/lang/String;
    .end local v14    # "tmpSuplServerPort":I
    .end local v15    # "tmppositionMode":I
    :cond_b
    :goto_7
    return-void
    ...
    .restart local v13    # "tmpSuplServerHost":Ljava/lang/String;
    .restart local v14    # "tmpSuplServerPort":I
    .restart local v15    # "tmppositionMode":I
    .restart local v16    # "value":Ljava/lang/String;
    .restart local v17    # "valueColumn":I
    :cond_c
    :try_start_1
    ...
    const-string v3, "mPositionMode: GPS_POSITION_MODE_MS_BASED"
    ...
    const-string v3, "mPositionMode: GPS_POSITION_MODE_MS_ASSISTED"
