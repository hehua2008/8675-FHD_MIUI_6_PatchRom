...
.field private mIsOtherDomainInfoBound:Z

.field private mIsVrtEnabled:Z
...
.field private mOtherDomainConn:Landroid/content/ServiceConnection;

.field private mOtherDomainInfo:Lcom/redbend/vlm/IOtherDomainInfo;
...
.method private constructor <init>()V
    ...
    iput-object v0, p0, Lcom/android/internal/telephony/CallManager;->mOtherDomainConn:Landroid/content/ServiceConnection;
    ...
    .line 230
    const-string v0, "ro.redbend.layout"
    ...
    const-string v1, "ro.redbend.layout"
    ...
    const-string v1, "we are in virutalization mode - allow query of other domain"
    ...
    iput-boolean v0, p0, Lcom/android/internal/telephony/CallManager;->mIsVrtEnabled:Z
...
.method static synthetic access$002(Lcom/android/internal/telephony/CallManager;Lcom/redbend/vlm/IOtherDomainInfo;)Lcom/redbend/vlm/IOtherDomainInfo;
    .locals 0
    .param p0, "x0"    # Lcom/android/internal/telephony/CallManager;
    .param p1, "x1"    # Lcom/redbend/vlm/IOtherDomainInfo;

    .prologue
    .line 67
    iput-object p1, p0, Lcom/android/internal/telephony/CallManager;->mOtherDomainInfo:Lcom/redbend/vlm/IOtherDomainInfo;
...
.method private bindOtherDomainInfo()V
    .locals 5
    ...
    const-class v3, Lcom/redbend/vlm/IOtherDomainInfo;
    ...
    iget-object v3, p0, Lcom/android/internal/telephony/CallManager;->mOtherDomainConn:Landroid/content/ServiceConnection;
    ...
    iput-boolean v1, p0, Lcom/android/internal/telephony/CallManager;->mIsOtherDomainInfoBound:Z
    :try_end_0
    ...
    const-string v2, "Couldn\'t bind to OtherDomainInfoService."
...
.method static declared-synchronized setAudioModeForThread(Landroid/content/Context;I)V
    ...
    .prologue
    .line 2372
    const-class v4, Lcom/android/internal/telephony/CallManager;
    ...
    const-string v6, "audioManager.setAudioModeForThread begin: "
    ...
    const-string v6, "audioManager.setAudioModeForThread end: "
    ...
    invoke-static {v6}, Lcom/android/internal/telephony/CallManager;->audioModeToString(I)Ljava/lang/String;
    ...
    const-string v5, "requestAudioFocus on STREAM_RING"
    ...
    .end local v1    # "currentMode":Ljava/lang/String;
    ...
    .restart local v1    # "currentMode":Ljava/lang/String;
    .restart local v2    # "oldMode":I
    :pswitch_1
    :try_start_2
    const-string v3, "CallManager"

    const-string v5, "requestAudioFocus on STREAM_VOICE_CALL"
...
.method private unregisterForPhoneStates(Lcom/android/internal/telephony/Phone;)V
    ...
    const-string v2, "CallManager unregisterForPhoneStates"
...
.method protected finalize()V
    ...
    .prologue
    .line 249
    iget-object v0, p0, Lcom/android/internal/telephony/CallManager;->mOtherDomainConn:Landroid/content/ServiceConnection;
    ...
    iget-object v1, p0, Lcom/android/internal/telephony/CallManager;->mOtherDomainConn:Landroid/content/ServiceConnection;
...
.method public getOtherDomainState()Lcom/android/internal/telephony/PhoneConstants$State;
    .locals 8
    ...
    .line 2509
    .local v2, "otherDomainState":Lcom/android/internal/telephony/PhoneConstants$State;
    iget-boolean v5, p0, Lcom/android/internal/telephony/CallManager;->mIsVrtEnabled:Z
    ...
    .line 2546
    .end local v2    # "otherDomainState":Lcom/android/internal/telephony/PhoneConstants$State;
    .local v3, "otherDomainState":Lcom/android/internal/telephony/PhoneConstants$State;
    :goto_0
    return-object v3

    .line 2512
    .end local v3    # "otherDomainState":Lcom/android/internal/telephony/PhoneConstants$State;
    .restart local v2    # "otherDomainState":Lcom/android/internal/telephony/PhoneConstants$State;
    :cond_0
    iget-object v5, p0, Lcom/android/internal/telephony/CallManager;->mOtherDomainInfo:Lcom/redbend/vlm/IOtherDomainInfo;

    if-nez v5, :cond_3

    .line 2513
    const-string v1, "getOtherDomainState() - can\'t get other domain phone state."
    ...
    const-string v6, " Default phone was not set yet."
    ...
    .line 2527
    .end local v2    # "otherDomainState":Lcom/android/internal/telephony/PhoneConstants$State;
    .restart local v3    # "otherDomainState":Lcom/android/internal/telephony/PhoneConstants$State;
    goto :goto_0
    ...
    .restart local v2    # "otherDomainState":Lcom/android/internal/telephony/PhoneConstants$State;
    :cond_1
    iget-boolean v5, p0, Lcom/android/internal/telephony/CallManager;->mIsOtherDomainInfoBound:Z
    ...
    const-string v6, " OtherDomainInfo is binding..."
    ...
    const-string v6, " OtherDomainInfo is not bound. Trying to bind..."
    ...
    .line 2524
    invoke-direct {p0}, Lcom/android/internal/telephony/CallManager;->bindOtherDomainInfo()V
    ...
    invoke-interface {v5}, Lcom/redbend/vlm/IOtherDomainInfo;->getCallState()I
    ...
    const-string v7, "getOtherDomainState() - other domain phone state is "
    ...
    const-string v7, "getOtherDomainState(): couldn\'t get otherdomain\'s phone state: "
...
.method public getState()Lcom/android/internal/telephony/PhoneConstants$State;
    ...
    .line 351
    iget-boolean v4, p0, Lcom/android/internal/telephony/CallManager;->mIsVrtEnabled:Z

    if-eqz v4, :cond_3

    .line 352
    invoke-virtual {p0}, Lcom/android/internal/telephony/CallManager;->getOtherDomainState()Lcom/android/internal/telephony/PhoneConstants$State;

    move-result-object v1

    .line 353
    .local v1, "otherDomainState":Lcom/android/internal/telephony/PhoneConstants$State;
    const-string v4, "CallManager"
    ...
    const-string v6, "getState() - current phone state is "
    ...
    const-string v6, " Other domain phone state is "
    ...
    .line 361
    .end local v1    # "otherDomainState":Lcom/android/internal/telephony/PhoneConstants$State;
    :cond_3
    return-object v3
.end method
...
.method public registerPhone(Lcom/android/internal/telephony/Phone;)Z
    ...
    .line 438
    iget-boolean v1, p0, Lcom/android/internal/telephony/CallManager;->mIsVrtEnabled:Z

    if-eqz v1, :cond_1

    iget-boolean v1, p0, Lcom/android/internal/telephony/CallManager;->mIsOtherDomainInfoBound:Z
...
.method public declared-synchronized setAudioFocus(I)V
    .locals 4
    .param p1, "mode"    # I
    ...
    const-string v3, "audioManager.setAudioFocus: "
    ...
    const-string v2, "requestAudioFocus on STREAM_RING"
    ...
    const-string v2, "requestAudioFocus on STREAM_VOICE_CALL"
...
.method public setAudioMode()V
    ...
    invoke-virtual {p0, v0}, Lcom/android/internal/telephony/CallManager;->setAudioMode(I)V
...
.method public setAudioMode(I)V
    ...
    sget-object v9, Lcom/android/internal/telephony/CallManager$3;->$SwitchMap$com$android$internal$telephony$PhoneConstants$State:[I
    ...
    invoke-interface {v9, v10, v11, v12, v13}, Lcom/android/internal/telephony/Phone;->rilIoControl(ILjava/lang/String;Ljava/lang/String;Landroid/os/Message;)V

    .line 664
    const-string v9, ""

    const-string v10, "ro.redbend.vlm.version"
    ...
    const-string v10, "normal system,need to set audio mode"
    ...
    const-string v11, "sendAudioModeMsg="
    ...
    const-string v11, ", active phoneid="
    ...
    .line 623
    .local v7, "offhookPhone":Lcom/android/internal/telephony/Phone;
    ...
    const-string v11, "setAudioMode, offhookPhone IS "
    ...
    .line 633
    .local v4, "hasActiveFg":Z
    invoke-virtual {p0}, Lcom/android/internal/telephony/CallManager;->hasActiveBgCall()Z

    move-result v3

    .line 634
    .local v3, "hasActiveBg":Z
    const-string v9, "CallManager"
    ...
    .line 642
    iget-object v9, p0, Lcom/android/internal/telephony/CallManager;->mPhones:Ljava/util/ArrayList;
    ...
    check-cast v8, Lcom/android/internal/telephony/Phone;

    .line 643
    .local v8, "tmpPhone":Lcom/android/internal/telephony/Phone;
    ...
    .end local v8    # "tmpPhone":Lcom/android/internal/telephony/Phone;
    :cond_8
    move-object v0, v7
    ...
    .line 655
    invoke-static {v1}, Lcom/yulong/android/modemservice/CPPhoneProperties;->getAudioMode(I)I
