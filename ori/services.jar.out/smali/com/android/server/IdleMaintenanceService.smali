...
.method static synthetic access$000(Lcom/android/server/IdleMaintenanceService;)V
    .locals 0
    .param p0, "x0"    # Lcom/android/server/IdleMaintenanceService;

    .prologue
    .line 51
    invoke-direct {p0}, Lcom/android/server/IdleMaintenanceService;->processScreenOnReceiveFunc()V

    return-void
.end method

.method static synthetic access$100(Lcom/android/server/IdleMaintenanceService;)V
    .locals 0
    .param p0, "x0"    # Lcom/android/server/IdleMaintenanceService;

    .prologue
    .line 51
    invoke-direct {p0}, Lcom/android/server/IdleMaintenanceService;->processScreenOffReceiveFunc()V
...
.method private processScreenOffReceiveFunc()V
    .locals 2
    ...
    iput-wide v0, p0, Lcom/android/server/IdleMaintenanceService;->mLastUserActivityElapsedTimeMillis:J
...
.method private processScreenOnReceiveFunc()V
    .locals 2
    ...
    invoke-direct {p0, v0}, Lcom/android/server/IdleMaintenanceService;->updateIdleMaintenanceState(Z)V
...
.method public onReceive(Landroid/content/Context;Landroid/content/Intent;)V
    ...
    .line 314
    invoke-direct {p0, v4}, Lcom/android/server/IdleMaintenanceService;->updateIdleMaintenanceState(Z)V
    ...
    .line 319
    new-instance v3, Lcom/android/server/IdleMaintenanceService$1;

    invoke-direct {v3, p0}, Lcom/android/server/IdleMaintenanceService$1;-><init>(Lcom/android/server/IdleMaintenanceService;)V

    invoke-virtual {v3}, Lcom/android/server/IdleMaintenanceService$1;->start()V
    ...
    .line 333
    new-instance v3, Lcom/android/server/IdleMaintenanceService$2;

    invoke-direct {v3, p0}, Lcom/android/server/IdleMaintenanceService$2;-><init>(Lcom/android/server/IdleMaintenanceService;)V

    invoke-virtual {v3}, Lcom/android/server/IdleMaintenanceService$2;->start()V
