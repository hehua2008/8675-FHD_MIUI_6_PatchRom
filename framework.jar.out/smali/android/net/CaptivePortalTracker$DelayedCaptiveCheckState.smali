...
.method public processMessage(Landroid/os/Message;)Z
    ...
    .line 307
    .end local v3    # "server":Ljava/net/InetAddress;
    :goto_2
    iget-object v5, p0, Landroid/net/CaptivePortalTracker$DelayedCaptiveCheckState;->this$0:Landroid/net/CaptivePortalTracker;
    ...
    invoke-static {v5, v6, v0}, Landroid/net/CaptivePortalTracker;->access$3000(Landroid/net/CaptivePortalTracker;Landroid/net/NetworkInfo;Z)V
    ...
    invoke-static {v5}, Landroid/net/CaptivePortalTracker;->access$3200(Landroid/net/CaptivePortalTracker;)Landroid/net/IConnectivityManager;
    ...
    invoke-static {v9}, Landroid/net/CaptivePortalTracker;->access$3100(Landroid/net/CaptivePortalTracker;)Ljava/lang/String;
    ...
    # invokes: Landroid/net/CaptivePortalTracker;->log(Ljava/lang/String;)V
    invoke-static {v5, v6}, Landroid/net/CaptivePortalTracker;->access$3300(Landroid/net/CaptivePortalTracker;Ljava/lang/String;)V
    ...
    .restart local v3    # "server":Ljava/net/InetAddress;
    :cond_2
    move v0, v5
    ...
    const-string v6, "Not captive network not cts mode"
