...
.method private bootCompleted()V
    ...
    invoke-virtual {v2, v7, v6, v8}, Lcom/android/server/input/InputManagerService;->getSwitchState(III)I
    ...
    invoke-virtual {v2, v7, v6, v3}, Lcom/android/server/input/InputManagerService;->getSwitchState(III)I
    ...
    const-string v2, "yulong.media.int.headset.state"
    ...
    .line 145
    iput v5, p0, Lcom/android/server/WiredAccessoryManager;->mHeadsetState:I
    ...
    .restart local v1    # "switchValues":I
    :sswitch_0
    iput v5, p0, Lcom/android/server/WiredAccessoryManager;->mHeadsetState:I
    ...
    .line 133
    :sswitch_1
    iput v8, p0, Lcom/android/server/WiredAccessoryManager;->mHeadsetState:I
...
.method private setDeviceStateLocked(IIILjava/lang/String;)V
    ...
    const-string v3, "ww:needn\'t to request closed HEADSET_NO_MIC"
    ...
    const-string v4, "ww:device HEADSET_NO_MIC "
    ...
    invoke-virtual {v2, v6, v3, p4}, Landroid/media/AudioManager;->setWiredDeviceConnectionState(IILjava/lang/String;)V
