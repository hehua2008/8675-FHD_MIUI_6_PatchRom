...
.method doHandleMessage(Landroid/os/Message;)V
    ...
    .line 887
    .local v27, "components":[Ljava/util/ArrayList;, "[Ljava/util/ArrayList<Ljava/lang/String;>;"
    move/from16 v0, v54
    ...
    aget-object v4, v47, v34

    const/4 v6, 0x1

    aget-object v7, v27, v34
    ...
    .line 917
    .end local v27    # "components":[Ljava/util/ArrayList;, "[Ljava/util/ArrayList<Ljava/lang/String;>;"
    .end local v34    # "i":I
    .end local v42    # "n":I
    ...
    .line 939
    .local v28, "data":Lcom/android/server/pm/PackageManagerService$PostInstallData;
    move-object/from16 v0, p0
    ...
    const-string v6, "POST_INSTALL:sendPackageBroadcast()-ACTION_PACKAGE_ADDED:packagename="
    ...
    const-string v6, "PackageInstalledInfo, name:"
    ...
    iget v6, v0, Lcom/android/server/pm/PackageManagerService$PackageInstalledInfo;->uid:I
    ...
    const-string v6, "InstallArgs, flags:"
    ...
    iget v6, v0, Lcom/android/server/pm/PackageManagerService$InstallArgs;->flags:I

    invoke-virtual {v4, v6}, Ljava/lang/StringBuilder;->append(I)Ljava/lang/StringBuilder;

    move-result-object v4

    const-string v6, ", packageURI:"
    ...
    const-string v4, "Fail returnCode:"
    ...
    .line 1052
    .local v37, "infoPrivate":Ljava/lang/String;
    move-object/from16 v0, p0
    ...
    # invokes: Lcom/android/server/pm/PackageManagerService;->ReportInstallFailed(Ljava/lang/String;Ljava/lang/String;)V
    invoke-static {v3, v4, v0}, Lcom/android/server/pm/PackageManagerService;->access$900(Lcom/android/server/pm/PackageManagerService;Ljava/lang/String;Ljava/lang/String;)V

    .line 1071
    .end local v37    # "infoPrivate":Ljava/lang/String;
    :cond_1e
    :goto_a
    if-eqz v30, :cond_1f
    ...
    .line 1055
    .local v29, "dataDir":Ljava/io/File;
    ...
    .line 1056
    .local v56, "systemDir":Ljava/io/File;
    new-instance v26, Ljava/io/File;

    const-string v3, "/data/brs/temp"

    const-string v4, "system_critical@package_install_failed.txt"
    ...
    .line 1057
    .local v26, "brsFile":Ljava/io/File;
    const-string v3, "PackageManager"
    ...
    # invokes: Lcom/android/server/pm/PackageManagerService;->ReportInstallFailed(Ljava/lang/String;Ljava/lang/String;)V
    invoke-static {v3, v4, v6}, Lcom/android/server/pm/PackageManagerService;->access$900(Lcom/android/server/pm/PackageManagerService;Ljava/lang/String;Ljava/lang/String;)V

    goto/16 :goto_a

    .line 1074
    .end local v26    # "brsFile":Ljava/io/File;
    .end local v29    # "dataDir":Ljava/io/File;
    .end local v56    # "systemDir":Ljava/io/File;
    :catchall_2
    move-exception v3
    ...
    .line 1089
    .end local v28    # "data":Lcom/android/server/pm/PackageManagerService$PostInstallData;
    ...
    .line 1210
    .end local v22    # "args":Lcom/android/server/pm/PackageManagerService$InstallArgs;
    .end local v52    # "response":Lcom/android/server/pm/PackageVerificationResponse;
    .end local v53    # "ret":I
    .end local v55    # "state":Lcom/android/server/pm/PackageVerificationState;
    .end local v64    # "verificationId":I
    :pswitch_e
    ...
    iget-object v4, v3, Lcom/android/server/pm/PackageManagerService;->mCreateLock:Ljava/lang/Object;
    ...
    # invokes: Lcom/android/server/pm/PackageManagerService;->createLimitedUser()V
    invoke-static {v3}, Lcom/android/server/pm/PackageManagerService;->access$1500(Lcom/android/server/pm/PackageManagerService;)V

    .line 1217
    .end local v62    # "userIds":[I
    :cond_30
    monitor-exit v4
