...
.method public static createFromPdu([B)Lcom/android/internal/telephony/cdma/SmsMessage;
    ...
    const-string v5, "google parse PDU"
...
.method public static newFromParcel(Landroid/os/Parcel;)Lcom/android/internal/telephony/cdma/SmsMessage;
    ...
    iget v11, v0, Lcom/android/internal/telephony/cdma/sms/CdmaSmsAddress;->ton:I
...
.method private parsePdu([B)V
    ...
    iget v7, v4, Lcom/android/internal/telephony/cdma/sms/SmsEnvelope;->serviceCategory:I
...
.method private static privateGetSubmitPdu(Ljava/lang/String;ZLcom/android/internal/telephony/cdma/sms/UserData;)Lcom/android/internal/telephony/cdma/SmsMessage$SubmitPdu;
    ...
    .prologue
    const-string v20, "SmsMessage"

    const-string v21, "enter privateGetSubmitPdu"
    ...
    .local v19, "tmpContentResolver":Landroid/content/ContentResolver;
    :try_start_0
    const-string v20, "yulong.sms.priority"
    ...
    .local v16, "sCallBackNumber":Ljava/lang/String;
    :try_start_1
    const-string v20, "yulong.mms.callback.number"
    ...
    const-string v22, "the sCallBackNumber = "
    ...
    :cond_2
    const-string v20, "persist.sys.language"
    ...
    invoke-static {v12}, Lcom/android/internal/telephony/cdma/sms/BearerData;->getLanguageValueForCode(Ljava/lang/String;)I
    ...
    iput-boolean v0, v4, Lcom/android/internal/telephony/cdma/sms/BearerData;->languageIndicatorSet:Z

    iput v15, v4, Lcom/android/internal/telephony/cdma/sms/BearerData;->language:I

    .end local v12    # "l":Ljava/lang/String;
    .end local v15    # "ret":I
    .end local v16    # "sCallBackNumber":Ljava/lang/String;
    .end local v19    # "tmpContentResolver":Landroid/content/ContentResolver;
    :cond_3
    :goto_3
    const/16 v20, 0xf7
    ...
    invoke-static/range {v20 .. v20}, Lcom/android/internal/telephony/cdma/SmsMessage;->getValidityPeriodRelative(Landroid/content/Context;)I
    ...
    invoke-static/range {v20 .. v21}, Landroid/telephony/Rlog;->isLoggable(Ljava/lang/String;I)Z
    ...
    const-string v21, "encodedBearerData is null"
    ...
    .restart local v19    # "tmpContentResolver":Landroid/content/ContentResolver;
    :catch_0
    move-exception v8
    ...
    const-string v21, "Get priority error."
    ...
    .restart local v16    # "sCallBackNumber":Ljava/lang/String;
    :catch_1
    move-exception v8
    ...
    const-string v21, "Get callback number error."
    ...
    .end local v19    # "tmpContentResolver":Landroid/content/ContentResolver;
    :cond_7
    iput v14, v4, Lcom/android/internal/telephony/cdma/sms/BearerData;->priority:I
    ...
    .end local v17    # "tel_service_id":I
    :cond_a
    const-string v20, "SmsMessage"
    ...
    const-string v22, "privateGetSubmitPdu teleservice = "
    ...
    iget v0, v6, Lcom/android/internal/telephony/cdma/sms/CdmaSmsAddress;->ton:I
    ...
    const-string v22, "creating SubmitPdu failed: "
...
.method public getAddressWithPlus(Lcom/android/internal/telephony/cdma/sms/CdmaSmsAddress;)Ljava/lang/String;
    .locals 13
    .param p1, "origAddress"    # Lcom/android/internal/telephony/cdma/sms/CdmaSmsAddress;
    ...
    iget-object v9, p1, Lcom/android/internal/telephony/cdma/sms/CdmaSmsAddress;->origBytes:[B
    ...
    iget v9, p1, Lcom/android/internal/telephony/cdma/sms/CdmaSmsAddress;->ton:I
...
.method public parseCdmaAddress([BI)Lcom/android/internal/telephony/cdma/sms/CdmaSmsAddress;
    ...
    iget v7, v0, Lcom/android/internal/telephony/cdma/sms/CdmaSmsAddress;->ton:I
