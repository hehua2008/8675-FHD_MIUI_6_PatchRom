...
.field protected static final EVENT_GET_SMSC_ADDR_DONE:I = 0x7
...
.field protected static final EVENT_SET_SMSC_ADDR_DONE:I = 0x9

.field protected static final EVENT_SMS_PARAM_DONE:I = 0x5

.field protected static final EVENT_SMS_WRITE_CARD_DONE:I = 0x6
...
# direct methods
.method public constructor <init>(Lcom/android/internal/telephony/PhoneBase;Lcom/android/internal/telephony/SMSDispatcher;)V
    .locals 4
    ...
    iput-object v2, p0, Lcom/android/internal/telephony/IccSmsInterfaceManager;->LOG_TAG:Ljava/lang/String;
...
.method public setSMSCAddr(Ljava/lang/String;)Z
    ...
    :cond_0
    const-string v3, "set smsc address not supported"
    ...
    const-string v3, "setSMSCAddr mSuccess = "
...
.method public updateMessageOnIccEf(Ljava/lang/String;II[B)Z
    ...
    invoke-virtual {v2, v7, v4, p1}, Landroid/app/AppOpsManager;->noteOp(IILjava/lang/String;)I
    ...
    const-string v4, "updateMessageOnIccEf Binder.getCallingUid() "
    ...
    const-string v4, ", OP_WRITE_ICC_SMS not allowed"
    ...
    invoke-virtual {v2, v7, v4, p1, v1}, Landroid/app/AppOpsManager;->setMode(IILjava/lang/String;I)V
...
.method protected waitForResult(Ljava/util/concurrent/atomic/AtomicBoolean;)V
    .locals 2
    .param p1, "cond"    # Ljava/util/concurrent/atomic/AtomicBoolean;
...
.method public writeSmsToCard(ILjava/lang/String;Ljava/lang/String;Ljava/lang/String;)I
    ...
    const-string v4, "writeSmsToCard: status="
    ...
    const-string v3, "Copying message to SIM"

    move-object/from16 v0, p0

    invoke-virtual {v0, v3}, Lcom/android/internal/telephony/IccSmsInterfaceManager;->enforceReceiveAndSend(Ljava/lang/String;)V
    ...
    iput v3, v0, Lcom/android/internal/telephony/IccSmsInterfaceManager;->index:I
    ...
    .local v9, "cond":Ljava/util/concurrent/atomic/AtomicBoolean;
    move-object/from16 v0, p0

    iget-object v3, v0, Lcom/android/internal/telephony/IccSmsInterfaceManager;->mHandler:Landroid/os/Handler;
    ...
    iget-object v4, v0, Lcom/android/internal/telephony/IccSmsInterfaceManager;->mPhone:Lcom/android/internal/telephony/PhoneBase;
    ...
    invoke-static {v3, v0, v1, v4, v2}, Lcom/android/internal/telephony/gsm/SmsMessage;->getDeliverPdu(Ljava/lang/String;Ljava/lang/String;Ljava/lang/String;ZLjava/lang/String;)Lcom/android/internal/telephony/gsm/SmsMessage$SubmitPdu;
    :try_end_1
    ...
    invoke-interface {v3, v0, v4, v5, v1}, Lcom/android/internal/telephony/CommandsInterface;->writeSmsToSim(ILjava/lang/String;Ljava/lang/String;Landroid/os/Message;)V

    new-instance v3, Ljava/lang/StringBuilder;

    invoke-direct {v3}, Ljava/lang/StringBuilder;-><init>()V

    const-string v4, "writeSmsToSim pdu.encodedMessage = "
    ...
    .end local v19    # "telTem":[B
    .end local v20    # "teleNumBytes":[B
    :goto_4
    move-object/from16 v0, p0

    invoke-virtual {v0, v9}, Lcom/android/internal/telephony/IccSmsInterfaceManager;->waitForResult(Ljava/util/concurrent/atomic/AtomicBoolean;)V
    ...
    iget v3, v0, Lcom/android/internal/telephony/IccSmsInterfaceManager;->index:I

    goto/16 :goto_0

    .restart local v19    # "telTem":[B
    :cond_1
    const/4 v3, 0x0
    ...
    .restart local v20    # "teleNumBytes":[B
    const/4 v3, 0x0
    ...
    .end local v9    # "cond":Ljava/util/concurrent/atomic/AtomicBoolean;
    ...
    .restart local v9    # "cond":Ljava/util/concurrent/atomic/AtomicBoolean;
    .restart local v16    # "pdu":Lcom/android/internal/telephony/gsm/SmsMessage$SubmitPdu;
    .restart local v17    # "response":Landroid/os/Message;
    .restart local v19    # "telTem":[B
    .restart local v20    # "teleNumBytes":[B
    :catch_0
    move-exception v13
    ...
    :cond_3
    const-string v3, "writeSmsToRuim pdu = null"
    ...
    .local v14, "encoding":B
    const/4 v3, 0x0

    move-object/from16 v0, p3

    invoke-static {v0, v3}, Lcom/android/internal/telephony/cdma/SmsMessage;->calculateLength(Ljava/lang/CharSequence;Z)Lcom/android/internal/telephony/GsmAlphabet$TextEncodingDetails;

    move-result-object v11

    .local v11, "details":Lcom/android/internal/telephony/GsmAlphabet$TextEncodingDetails;
    iget v3, v11, Lcom/android/internal/telephony/GsmAlphabet$TextEncodingDetails;->codeUnitSize:I
    ...
    const-string v4, "writeSmsToCard message: encoding = "
    ...
    invoke-static/range {v3 .. v8}, Lcom/android/internal/telephony/cdma/SmsMessage;->getSubmitPdu(Ljava/lang/String;Ljava/lang/String;Ljava/lang/String;ZLcom/android/internal/telephony/SmsHeader;Ljava/lang/String;)Lcom/android/internal/telephony/cdma/SmsMessage$SubmitPdu;
    ...
    invoke-interface {v3, v0, v4, v1}, Lcom/android/internal/telephony/CommandsInterface;->writeSmsToRuim(I[BLandroid/os/Message;)V

    new-instance v3, Ljava/lang/StringBuilder;

    invoke-direct {v3}, Ljava/lang/StringBuilder;-><init>()V

    const-string v4, "writeSmsToRuim pdu = "
