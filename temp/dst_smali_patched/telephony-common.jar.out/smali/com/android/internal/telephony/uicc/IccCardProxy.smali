...
.annotation system Ldalvik/annotation/MemberClasses;
    value = {
        ...
        Lcom/android/internal/telephony/uicc/IccCardProxy$BaseHandler;
    }
.end annotation
...
.field private mBaseHandler:Lcom/android/internal/telephony/uicc/IccCardProxy$BaseHandler;
...
.method public constructor <init>(Landroid/content/Context;Lcom/android/internal/telephony/CommandsInterface;)V
    ...
    iput-object v3, p0, Lcom/android/internal/telephony/uicc/IccCardProxy;->mBaseHandler:Lcom/android/internal/telephony/uicc/IccCardProxy$BaseHandler;
    ...
    const-string v1, "IccCardProxyHandler"
    ...
    new-instance v1, Lcom/android/internal/telephony/uicc/IccCardProxy$BaseHandler;

    invoke-virtual {v0}, Landroid/os/HandlerThread;->getLooper()Landroid/os/Looper;

    move-result-object v2

    invoke-direct {v1, p0, v2}, Lcom/android/internal/telephony/uicc/IccCardProxy$BaseHandler;-><init>(Lcom/android/internal/telephony/uicc/IccCardProxy;Landroid/os/Looper;)V

    iput-object v1, p0, Lcom/android/internal/telephony/uicc/IccCardProxy;->mBaseHandler:Lcom/android/internal/telephony/uicc/IccCardProxy$BaseHandler;
...
.method static synthetic access$100(Lcom/android/internal/telephony/uicc/IccCardProxy;)Ljava/lang/Object;
    .locals 1
    .param p0, "x0"    # Lcom/android/internal/telephony/uicc/IccCardProxy;
...
.method static synthetic access$200(Lcom/android/internal/telephony/uicc/IccCardProxy;Ljava/lang/String;)V
    ...
    .prologue
    invoke-direct {p0, p1}, Lcom/android/internal/telephony/uicc/IccCardProxy;->loge(Ljava/lang/String;)V

    return-void
.end method

.method static synthetic access$300(Lcom/android/internal/telephony/uicc/IccCardProxy;)I
    .locals 1
    .param p0, "x0"    # Lcom/android/internal/telephony/uicc/IccCardProxy;

    .prologue
    iget v0, p0, Lcom/android/internal/telephony/uicc/IccCardProxy;->mPinPukCount:I

    return v0
.end method

.method static synthetic access$302(Lcom/android/internal/telephony/uicc/IccCardProxy;I)I
    .locals 0
    .param p0, "x0"    # Lcom/android/internal/telephony/uicc/IccCardProxy;
    .param p1, "x1"    # I

    .prologue
    iput p1, p0, Lcom/android/internal/telephony/uicc/IccCardProxy;->mPinPukCount:I
...
.method private broadcastIccStateChangedIntent(Ljava/lang/String;Ljava/lang/String;)V
    ...
    const-string v2, "china mobile xianwang test,do not notify card absent"
...
.method public changeIccLockPassword(Ljava/lang/String;Ljava/lang/String;Landroid/os/Message;)V
    ...
    const-string v5, "enter changeIccLockPassword..."
    ...
    invoke-virtual {v4, p1, p2, p3}, Lcom/android/internal/telephony/uicc/UiccCardApplication;->changeIccLockPassword(Ljava/lang/String;Ljava/lang/String;Landroid/os/Message;)V
    ...
    invoke-virtual {v4, v6}, Lcom/android/internal/telephony/uicc/UiccController;->getDualUiccCard(I)Lcom/android/internal/telephony/uicc/UiccCard;
    ...
    const-string v6, "mUiccApplication is null,use a non-null app to supply pin"
    ...
    .local v3, "ucApps":[Lcom/android/internal/telephony/uicc/UiccCardApplication;
    if-eqz v3, :cond_0
    ...
    .end local v3    # "ucApps":[Lcom/android/internal/telephony/uicc/UiccCardApplication;
    :catchall_0
    move-exception v4
    ...
    .restart local v2    # "uc":Lcom/android/internal/telephony/uicc/UiccCard;
    .restart local v3    # "ucApps":[Lcom/android/internal/telephony/uicc/UiccCardApplication;
    :cond_2
    ...
    const-string v4, "ICC card is absent."
...
.method public closeLogicalChannel(ILandroid/os/Message;)V
    ...
    iget-object v1, p0, Lcom/android/internal/telephony/uicc/IccCardProxy;->mBaseHandler:Lcom/android/internal/telephony/uicc/IccCardProxy$BaseHandler;

    const/16 v2, 0xf

    invoke-virtual {v1, v2, p2}, Lcom/android/internal/telephony/uicc/IccCardProxy$BaseHandler;->obtainMessage(ILjava/lang/Object;)Landroid/os/Message;
...
.method public dispose()V
    ...
    invoke-virtual {p0, v0}, Lcom/android/internal/telephony/uicc/IccCardProxy;->removeCallbacksAndMessages(Ljava/lang/Object;)V
...
.method public exchangeAPDU(IIIIIILjava/lang/String;Landroid/os/Message;)V
    ...
    iget-object v2, p0, Lcom/android/internal/telephony/uicc/IccCardProxy;->mBaseHandler:Lcom/android/internal/telephony/uicc/IccCardProxy$BaseHandler;

    const/16 v3, 0xd

    move-object/from16 v0, p8

    invoke-virtual {v2, v3, v0}, Lcom/android/internal/telephony/uicc/IccCardProxy$BaseHandler;->obtainMessage(ILjava/lang/Object;)Landroid/os/Message;
...
.method public getAtr(Landroid/os/Message;)V
    ...
    invoke-virtual {v1, v2, p1}, Lcom/android/internal/telephony/uicc/IccCardProxy$BaseHandler;->obtainMessage(ILjava/lang/Object;)Landroid/os/Message;
...
.method public getIccLockEnabled()Z
    ...
    .end local v0    # "i":I
    .end local v1    # "retValue":Ljava/lang/Boolean;
    .end local v2    # "uc":Lcom/android/internal/telephony/uicc/UiccCard;
    .end local v3    # "ucApps":[Lcom/android/internal/telephony/uicc/UiccCardApplication;
    :catchall_0
    move-exception v4
    ...
    .restart local v1    # "retValue":Ljava/lang/Boolean;
    .restart local v2    # "uc":Lcom/android/internal/telephony/uicc/UiccCard;
    .restart local v3    # "ucApps":[Lcom/android/internal/telephony/uicc/UiccCardApplication;
    :cond_2
    add-int/lit8 v0, v0, 0x1
...
.method public handleMessage(Landroid/os/Message;)V
    ...
    const-string v1, "icccard enter handleMessage "
...
.method public setIccCardLock()Z
    ...
    :try_start_0
    iget-object v7, p0, Lcom/android/internal/telephony/uicc/IccCardProxy;->mBaseHandler:Lcom/android/internal/telephony/uicc/IccCardProxy$BaseHandler;
...
.method public setIccLockEnabled(ZLjava/lang/String;Landroid/os/Message;)V
    ...
    const-string v5, "enter setIccLockEnabled..."
    ...
    invoke-virtual {v4, p1, p2, p3}, Lcom/android/internal/telephony/uicc/UiccCardApplication;->setIccLockEnabled(ZLjava/lang/String;Landroid/os/Message;)V
...
.method public supplyPin(Ljava/lang/String;Landroid/os/Message;)V
    ...
    const-string v5, "enter supplyPin..."
    ...
    invoke-virtual {v4, p1, p2}, Lcom/android/internal/telephony/uicc/UiccCardApplication;->supplyPin(Ljava/lang/String;Landroid/os/Message;)V
...
.method public supplyPin2(Ljava/lang/String;Landroid/os/Message;)V
    ...
    const-string v2, "enter supplyPin2..."
...
.method public supplyPuk(Ljava/lang/String;Ljava/lang/String;Landroid/os/Message;)V
    ...
    const-string v5, "enter supplyPuk..."
    ...
    invoke-virtual {v4, p1, p2, p3}, Lcom/android/internal/telephony/uicc/UiccCardApplication;->supplyPuk(Ljava/lang/String;Ljava/lang/String;Landroid/os/Message;)V
...
.method public supplyPuk2(Ljava/lang/String;Ljava/lang/String;Landroid/os/Message;)V
    ...
    const-string v2, "enter supplyPuk2..."
