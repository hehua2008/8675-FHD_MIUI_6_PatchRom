...
.method public constructor <init>(Landroid/content/Context;)V
    ...
    iput-boolean v4, p0, Landroid/media/AudioService;->mFirstConnection:Z
    ...
    const-string v2, "mMasterVolumeRamp["
    ...
    const-string v2, "mMasterVolumeRamp.length "
...
.method private adjustMasterVolume_oldman(IILjava/lang/String;)V
    ...
    const-string v14, "sendVolumeUpdate: StreamType = "
...
.method private onCheckMusicActive()V
    ...
    const-string v2, "on check music active "
...
.method private onConfigureSafeVolume(Z)V
    ...
    const-string v2, "onConfigureSafeVolume mcc "
    ...
    const-string v2, "onConfigureSafeVolume mSafeMediaVolumeIndex "
...
.method private readPersistedSettings()V
    ...
    :cond_3
    const-string v8, "persist.yulong.ctstest"
    ...
    const-string v8, "vibrate_mode_state"
    ...
    const-string v10, "vibrate_mode_state from database is "
...
.method private restoreMasterVolume()V
    ...
    const-string v3, "restoreMasterVolume : "
...
.method private setSafeMediaVolumeEnabled(Z)V
    ...
    const-string v2, "setSafeMediaVolumeEnabled state "
...
.method private setStreamVolumeInt(IIIZ)V
    ...
    const-string v3, "setStreamVolumeInt stmType: "
...
.method public adjustStreamVolume(IIILjava/lang/String;)V
    ...
    const-string v5, ", mUseMasterVolume="
    ...
    iget-boolean v5, v0, Landroid/media/AudioService;->mUseMasterVolume:Z
    ...
    .local v12, "ctsflag":Ljava/lang/String;
    const-string v3, "0"
    ...
    iget-object v3, v0, Landroid/media/AudioService;->mKeyguardManager:Landroid/app/KeyguardManager;
    ...
    :cond_2
    const-string v3, "persist.sys.hallsensor.switch"
    ...
    const-string v4, "when keyguard lock or hallsensor closed,can\'t ajust ring volume!"
    ...
    sget-boolean v3, Landroid/media/AudioManager;->speaker_mute_state:Z
    ...
    const-string v5, ">>>>>isAnyConnected = "
    ...
    const-string v5, ",AudioSystem.getMasterVolume() = "
    ...
    .end local v14    # "isAnyConnected":Z
    :cond_9
    move-object/from16 v0, p0
    ...
    const-string v5, "change volume index from oldindex "
    ...
    .end local v17    # "scenemodelmetting":Z
    .end local v18    # "scenemodelquiet":Z
    .end local v19    # "step":I
    ...
    .restart local v18    # "scenemodelquiet":Z
    :cond_13
    const/16 v17, 0x0

    goto/16 :goto_2

    .restart local v17    # "scenemodelmetting":Z
    :cond_14
    const/4 v14, 0x0

    goto/16 :goto_3

    .restart local v14    # "isAnyConnected":Z
    :cond_15
    sget-boolean v3, Landroid/media/AudioManager;->speaker_mute_state:Z
    ...
    const-string v4, " can not adjust stream volume in speaker_mutekey mode"
    ...
    const-string v4, " can not adjust stream volume in silent mode"
    ...
    const-string v4, " can not adjust stream volume in meeting mode"
...
.method public setMasterVolume(IILjava/lang/String;)V
    ...
    const-string v2, "setMasterVolume volume: "
...
.method public setSpeakerphoneOn(Z)V
    ...
    const-string v6, "set speaker phone on "
...
.method public setVibrateSetting(II)V
    ...
    const-string v2, "vibrate_mode_state"

    const/4 v3, -0x2

    invoke-static {v1, v2, p2, v3}, Landroid/provider/Settings$System;->putIntForUser(Landroid/content/ContentResolver;Ljava/lang/String;II)Z
...
.method public startBluetoothSco(Landroid/os/IBinder;I)V
    ...
    const-string v4, "start blue tooth sco"
...
.method public stopBluetoothSco(Landroid/os/IBinder;)V
    ...
    const-string v4, "stop blue tooth sco"
