...
# static fields
.field private static final AGENDA:Ljava/lang/String; = "agenda_alert"

.field private static final ALARMS_DIR:Ljava/lang/String; = "/alarms/"

.field private static final CALCULAGRAPH:Ljava/lang/String; = "calculagraph_alert"
...
.field private mDefaultAgendaAlertFilename:Ljava/lang/String;

.field private mDefaultAgendaSet:Z

.field private mDefaultAlarmAlertFilename:Ljava/lang/String;

.field private mDefaultAlarmSet:Z

.field private mDefaultCalculagraphAlertFilename:Ljava/lang/String;

.field private mDefaultCalculagraphSet:Z
...
.method static synthetic access$2600(Landroid/media/MediaScanner;)I
    ...
    .prologue
    iget v0, p0, Landroid/media/MediaScanner;->mDefaultflags:I

    return v0
.end method

.method static synthetic access$2602(Landroid/media/MediaScanner;I)I
    .locals 0
    .param p0, "x0"    # Landroid/media/MediaScanner;
    .param p1, "x1"    # I

    .prologue
    iput p1, p0, Landroid/media/MediaScanner;->mDefaultflags:I
...
.method static synthetic access$2700(Landroid/media/MediaScanner;)Z
    ...
    .prologue
    iget-boolean v0, p0, Landroid/media/MediaScanner;->mDefaultAgendaSet:Z
...
.method static synthetic access$2702(Landroid/media/MediaScanner;Z)Z
    ...
    .prologue
    iput-boolean p1, p0, Landroid/media/MediaScanner;->mDefaultAgendaSet:Z
...
.method static synthetic access$2800(Landroid/media/MediaScanner;)Ljava/lang/String;
    ...
    .prologue
    iget-object v0, p0, Landroid/media/MediaScanner;->mDefaultAgendaAlertFilename:Ljava/lang/String;
...
.method static synthetic access$2900(Landroid/media/MediaScanner;)Z
    ...
    .prologue
    iget-boolean v0, p0, Landroid/media/MediaScanner;->mDefaultCalculagraphSet:Z
...
.method static synthetic access$2902(Landroid/media/MediaScanner;Z)Z
    ...
    .prologue
    iput-boolean p1, p0, Landroid/media/MediaScanner;->mDefaultCalculagraphSet:Z
...
.method static synthetic access$3000(Landroid/media/MediaScanner;)Ljava/lang/String;
    ...
    .prologue
    iget-object v0, p0, Landroid/media/MediaScanner;->mDefaultCalculagraphAlertFilename:Ljava/lang/String;
...
.method private prescanFolders(Ljava/lang/String;Z)V
    ...
    const-string v6, "_id>? AND (_data=? OR _data LIKE ?)"
...
.method private setDefaultRingtoneFileNames()V
    ...
    const-string v0, "ro.config.agenda_alert"

    invoke-static {v0}, Landroid/os/SystemProperties;->get(Ljava/lang/String;)Ljava/lang/String;

    move-result-object v0

    iput-object v0, p0, Landroid/media/MediaScanner;->mDefaultAgendaAlertFilename:Ljava/lang/String;

    const-string v0, "ro.config.calculagraph_alert"

    invoke-static {v0}, Landroid/os/SystemProperties;->get(Ljava/lang/String;)Ljava/lang/String;

    move-result-object v0

    iput-object v0, p0, Landroid/media/MediaScanner;->mDefaultCalculagraphAlertFilename:Ljava/lang/String;
...
.method public scanFolders([Ljava/lang/String;Ljava/lang/String;)V
    .locals 23
    ...
    invoke-direct {v0, v2, v3}, Landroid/media/MediaScanner;->prescanFolders(Ljava/lang/String;Z)V
    ...
    invoke-direct {v2, v3, v4, v7}, Landroid/media/MediaInserter;-><init>(Landroid/content/IContentProvider;Ljava/lang/String;I)V
    ...
    .end local v13    # "end":J
    .end local v16    # "i":I
    .end local v17    # "prescan":J
    .end local v19    # "scan":J
    ...
    .end local v12    # "e":Ljava/lang/UnsupportedOperationException;
    :catch_2
    move-exception v12
