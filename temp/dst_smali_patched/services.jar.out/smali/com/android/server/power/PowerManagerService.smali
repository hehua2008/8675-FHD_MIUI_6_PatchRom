...
.field private static final MSG_RESET_BRIGHTNESS:I = 0x9
...
# instance fields
.field private HaveResetBrightness:Z
...
.field private mRecoardScreenBrightnessModeSetting:I
...
.method public constructor <init>()V
    ...
    iput-boolean v2, p0, Lcom/android/server/power/PowerManagerService;->HaveResetBrightness:Z

    iput-boolean v2, p0, Lcom/android/server/power/PowerManagerService;->mIsAdjustCpu:Z
...
.method static synthetic access$2000(Lcom/android/server/power/PowerManagerService;)Ljava/lang/String;
    .locals 1
    .param p0, "x0"    # Lcom/android/server/power/PowerManagerService;
...
.method static synthetic access$2100(Lcom/android/server/power/PowerManagerService;)Lcom/android/server/power/DisplayPowerRequest;
    .locals 1
    .param p0, "x0"    # Lcom/android/server/power/PowerManagerService;
...
.method static synthetic access$2200(Lcom/android/server/power/PowerManagerService;I)V
    .locals 0
    .param p0, "x0"    # Lcom/android/server/power/PowerManagerService;
    .param p1, "x1"    # I
...
.method static synthetic access$3600(Lcom/android/server/power/PowerManagerService;)Lcom/android/server/LightsService$Light;
    .locals 1
    .param p0, "x0"    # Lcom/android/server/power/PowerManagerService;
...
.method static synthetic access$5300(Lcom/android/server/power/PowerManagerService;)Landroid/app/AlarmManager;
    .locals 1
    .param p0, "x0"    # Lcom/android/server/power/PowerManagerService;
...
.method static synthetic access$5302(Lcom/android/server/power/PowerManagerService;Landroid/app/AlarmManager;)Landroid/app/AlarmManager;
    .locals 0
    .param p0, "x0"    # Lcom/android/server/power/PowerManagerService;
...
.method static synthetic access$5400(Lcom/android/server/power/PowerManagerService;)Landroid/app/PendingIntent;
    .locals 1
    .param p0, "x0"    # Lcom/android/server/power/PowerManagerService;
...
.method static synthetic access$5800(Lcom/android/server/power/PowerManagerService;)J
    .locals 2
    .param p0, "x0"    # Lcom/android/server/power/PowerManagerService;
...
.method static synthetic access$5902(I)I
    .locals 0
    .param p0, "x0"    # I
...
.method static synthetic access$6100(Lcom/android/server/power/PowerManagerService;)Lcom/android/server/LightsService$Light;
    .locals 1
    .param p0, "x0"    # Lcom/android/server/power/PowerManagerService;
...
.method static synthetic access$6208()I
    .locals 2
...
.method static synthetic access$6400(Lcom/android/server/power/PowerManagerService;)Landroid/os/Handler;
    .locals 1
    .param p0, "x0"    # Lcom/android/server/power/PowerManagerService;
...
.method private goToSleepNoUpdateLocked(JI)Z
    ...
    iget-boolean v6, p0, Lcom/android/server/power/PowerManagerService;->mIsAdjustCpu:Z

    if-eqz v6, :cond_2

    iget-object v6, p0, Lcom/android/server/power/PowerManagerService;->mPerf:Lorg/codeaurora/Performance;

    if-eqz v6, :cond_2

    iget-object v6, p0, Lcom/android/server/power/PowerManagerService;->mPerf:Lorg/codeaurora/Performance;

    invoke-virtual {v6}, Lorg/codeaurora/Performance;->perfLockRelease()I

    iput-boolean v5, p0, Lcom/android/server/power/PowerManagerService;->mIsAdjustCpu:Z

    :cond_2
    iget-boolean v5, p0, Lcom/android/server/power/PowerManagerService;->mIsAdjustCpu:Z

    if-nez v5, :cond_3

    iget-object v5, p0, Lcom/android/server/power/PowerManagerService;->mPerf:Lorg/codeaurora/Performance;
    ...
    iput-boolean v4, p0, Lcom/android/server/power/PowerManagerService;->mIsAdjustCpu:Z
...
.method private updateDisplayPowerStateLocked(I)V
    ...
    iget-boolean v5, p0, Lcom/android/server/power/PowerManagerService;->HaveResetBrightness:Z

    if-nez v5, :cond_3

    iput-boolean v6, p0, Lcom/android/server/power/PowerManagerService;->HaveResetBrightness:Z
    ...
    invoke-virtual {v5, v1}, Lcom/android/server/power/PowerManagerService$PowerManagerHandler;->sendMessageAtFrontOfQueue(Landroid/os/Message;)Z

    const-string v5, "PowerManagerService"

    const-string v6, "reset brightness if less then 30."
...
.method private wakeUpNoUpdateLocked(J)Z
    ...
    :cond_2
    iget-boolean v0, p0, Lcom/android/server/power/PowerManagerService;->mIsAdjustCpu:Z

    if-eqz v0, :cond_3

    iget-object v0, p0, Lcom/android/server/power/PowerManagerService;->mPerf:Lorg/codeaurora/Performance;
    ...
    iput-boolean v3, p0, Lcom/android/server/power/PowerManagerService;->mIsAdjustCpu:Z
    ...
    iput-boolean v6, p0, Lcom/android/server/power/PowerManagerService;->mIsAdjustCpu:Z
...
.method public systemReady(Lcom/android/server/TwilightService;Lcom/android/server/dreams/DreamManagerService;)V
    ...
    iput-object v2, v0, Lcom/android/server/power/PowerManagerService;->mPerf:Lorg/codeaurora/Performance;
    ...
    new-instance v3, Lcom/android/server/power/PowerManagerService$HallSensorReceiver;

    const/4 v4, 0x0

    move-object/from16 v0, p0

    invoke-direct {v3, v0, v4}, Lcom/android/server/power/PowerManagerService$HallSensorReceiver;-><init>(Lcom/android/server/power/PowerManagerService;Lcom/android/server/power/PowerManagerService$1;)V
